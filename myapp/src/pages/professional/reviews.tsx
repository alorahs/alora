  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Professional Reviews</h1>
          <p className="text-gray-600 mt-2">See what customers are saying about this professional</p>
        </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center py-6">
                  ...
                  <div className="mt-2 text-gray-600">{reviews.length} reviews</div>
                </div>
                ...
                <div className="space-y-3 mt-6">
                  {[5, 4, 3, 2, 1].map((rating) => (
                    <div key={rating} className="flex items-center">
                      <div className="w-10 text-sm font-medium text-gray-900">{rating} stars</div>
                      <div className="flex-1 mx-3">
                        <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                          <div 
                            className="h-full bg-yellow-400 rounded-full" 
                            style={{ width: `${reviews.length > 0 ? (ratingDistribution[5 - rating] / reviews.length) * 100 : 0}%` }}
                          ></div>
                        </div>
                      </div>
                      <div className="w-8 text-sm text-gray-600">{ratingDistribution[5 - rating]}</div>
                    </div>
                  ))}
                </div>
              </CardContent>
            ...
            {reviews.length === 0 ? (
              <Card>
                <CardContent className="text-center py-12">
                  ...
                  <p className="mt-1 text-gray-500">This professional doesn't have any reviews yet.</p>
                </CardContent>
              </Card>
            ) : (
