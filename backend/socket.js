...
export const initializeSocket = (server) => {
  ...
  ioInstance = new Server(server, {
    cors: {
      origin: process.env.CLIENT_URL || ['http://localhost:8080','http://10.186.236.2:8081','http://localhost:8081', 'http://localhost:8000', "http://10.244.78.2:8000", 'http://192.168.29.106:8000', 'http://192.168.29.162:8000','https://51090895-ce0d-4997-9b08-6afe46072bdb.lovableproject.com'],
